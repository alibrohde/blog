...
export default function Home() {
  return (
    <div className="text-gray-800 dark:text-gray-300">
      <Link href="https://twitter.com/RohdeAli" target="_blank">
        <Image
          src={aliPhoto}
          alt="Ali Rohde"
      ...
      <p className="mb-4">
        ...
        <Link href="https://www.outsetcapital.com/" className="underline hover:no-underline" target="_blank">
          Outset Capital
        </Link>
      ...
      <p className="mb-4">
        ...
        <Link href="https://browserbase.com/" className="underline hover:no-underline" target="_blank">Browserbase</Link>,{" "}
        <Link href="https://datologyai.com/" className="underline hover:no-underline" target="_blank">Datology AI</Link>,{" "}
        <Link href="https://hedra.com/" className="underline hover:no-underline" target="_blank">Hedra</Link>, and{" "}
        <Link href="https://physicalintelligence.company/" className="underline hover:no-underline" target="_blank">Physical Intelligence</Link>.
      </p>
