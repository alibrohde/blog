...
The tendency of any system to drift toward disorder unless energy is continuously put back in. From thermodynamics (Clausius, 1865) and later information theory (Shannon, 1948), the word has migrated into engineering shorthand for workflow decay. Shows up as the sleeper risk in every DIY stack: the people who regret self-hosting their CRM or agent pipeline six months in rarely regret the schema, they regret the creep of "one more script," broken ingestion jobs, and integrations that silently rot, a pattern HN and r/selfhosted threads on tools like Twenty surface again and again.
