...
Andrej Karpathy's 2024 reframing of the jagged frontier as a category problem, not a capability one: AI is not on the same axis as human intelligence at all, since in people most skills are correlated and rise together from childhood to adulthood while in AI they are uncorrelated across tasks. Shifts the labor debate from "is AI smarter than humans" to "which jagged peaks happen to overlap a given job."
